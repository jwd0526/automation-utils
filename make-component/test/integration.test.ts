...
function createArgs(overrides: Partial<CliArgs> = {}): CliArgs {
  ...
  const commandParts = ['make-component', args.componentName];
...
runner.test('Integration - Basic TypeScript component generation', async () => {
  ...
  TestAssertions.assertContains(componentContent, 'Generated by React Component Generator');
  TestAssertions.assertContains(componentContent, 'make-component Button --tsx');
  ...
  TestAssertions.assertContains(styleContent, 'Generated by React Component Generator');
  TestAssertions.assertContains(styleContent, 'make-component Button --tsx');
});
...
runner.test('Integration - Command headers verification', async () => {
  ...
  TestAssertions.assertContains(componentContent, '// Generated by React Component Generator');
  TestAssertions.assertContains(componentContent, '// Command: make-component HeaderTest -p "title:string,count:number" -s scss -e "div.header>h1.title" --jsx');
  TestAssertions.assertContains(componentContent, '// Generated at:');

  // Verify style header format
  TestAssertions.assertContains(styleContent, '// Generated by React Component Generator');
  TestAssertions.assertContains(styleContent, '// Command: make-component HeaderTest -p "title:string,count:number" -s scss -e "div.header>h1.title" --jsx');
